...
public class Intent implements android.os.Parcelable, Cloneable {
    ...
    public Intent(Context packageContext, Class<?> cls) { throw new RuntimeException("<Stub>!"); }
    public Intent(String action, android.net.Uri uri, Context packageContext, Class<?> cls) { throw new RuntimeException("<Stub>!"); }
    ...
    public  android.os.Bundle getBundleExtra(String name) { throw new RuntimeException("<Stub>!"); }
    ...
    public  Intent setDataAndNormalize(android.net.Uri data) { throw new RuntimeException("<Stub>!"); }
    public  Intent setType(String type) { return this; }
    public  Intent setTypeAndNormalize(String type) { throw new RuntimeException("<Stub>!"); }
    public  Intent setDataAndType(android.net.Uri data, String type) { throw new RuntimeException("<Stub>!"); }
    public  Intent setDataAndTypeAndNormalize(android.net.Uri data, String type) { throw new RuntimeException("<Stub>!"); }
    ...
    public  Intent putExtra(String name, String[] value) { return this; }
    public  Intent putExtra(String name, CharSequence[] value) { return this; }
    public  Intent putExtra(String name, android.os.Bundle value) { return this; }
    public  Intent putExtras(Intent src) { return this; }
    public  Intent putExtras(android.os.Bundle extras) { return this; }
    public  Intent replaceExtras(Intent src) { return this; }
    public  Intent replaceExtras(android.os.Bundle extras) { return this; }
    ...
    public  int fillIn(Intent other, int flags) { throw new RuntimeException("<Stub>!"); }
