...
trait AppsServices {
   ...
   */
  def getInstalledApplications(implicit context: ContextSupport): CatsService[Seq[Application]]
   ...
   */
  def getApplication(packageName: String)(implicit context: ContextSupport): CatsService[Application]
  ...
  /**
    ...
    */
  def getDefaultApps(implicit context: ContextSupport): CatsService[Seq[Application]]
}
