...
class LauncherItemMenu(context: Context, attr: AttributeSet, defStyleAttr: Int)
  ...
  LayoutInflater.from(context).inflate(R.layout.launcher_item_menu, this)

  private[this] val title = Option(findView(TR.launcher_title))

  private[this] val icon = Option(findView(TR.launcher_icon))
