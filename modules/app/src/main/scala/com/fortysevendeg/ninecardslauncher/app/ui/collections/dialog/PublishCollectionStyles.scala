...
import com.fortysevendeg.ninecardslauncher.process.theme.models.{CardLayoutBackgroundColor, DrawerIconColor, NineCardsTheme}
...
trait PublishCollectionStyles extends CommonStyles {
  ...
  def paginationItemStyle(implicit context: ContextWrapper, theme: NineCardsTheme): Tweak[TintableImageView] = {
