...
trait CloudStorageProcess {
  ...
  /**
    ...
    */
  def prepareForActualDevice[T <: CloudStorageResource](devices: Seq[T])(implicit context: ContextSupport): CatsService[(Option[T], Seq[T])]
  ...
  /**
    ...
    * @throws CloudStorageProcessException if the service throws an error
    */
  def getCloudStorageDevices(implicit context: ContextSupport): CatsService[Seq[CloudStorageDeviceSummary]]
  ...
  /**
    ...
    */
  def getCloudStorageDevice(cloudStorageResourceId: String): CatsService[CloudStorageDevice]
  ...
  /**
    ...
    */
  def createCloudStorageDevice(cloudStorageDevice: CloudStorageDeviceData): CatsService[CloudStorageDevice]
  ...
  /**
    ...
    * @throws CloudStorageProcessException if the services throws an error
    */
  def createOrUpdateActualCloudStorageDevice(collections: Seq[CloudStorageCollection], moments: Seq[CloudStorageMoment], dockApps: Seq[CloudStorageDockApp])(implicit context: ContextSupport): CatsService[CloudStorageDevice]
  ...
  /**
    ...
    * @throws CloudStorageProcessException if the device not exists or the service throws an error
    */
  def deleteCloudStorageDevice(cloudId: String): CatsService[Unit]
