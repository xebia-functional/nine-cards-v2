...
case class DeleteCacheCategoryResponse()

case class DeleteCacheCategoryByPackageRequest(`package`: String)

case class DeleteCacheCategoryByPackageResponse()
...
case class UpdateCacheCategoryResponse()
...
case class UpdateCollectionResponse()
...
case class DeleteGeoInfoResponse()
...
case class UpdateGeoInfoResponse()