...
trait RecommendationsProcess {
  ...
  /**
    ...
    */
  def getRecommendedAppsByCategory(category: NineCardsCategory, excludePackages: Seq[String] = Seq.empty)(implicit context: ContextSupport): TaskService[Seq[NotCategorizedPackage]]
  ...
  /**
    ...
    * @throws RecommendedAppsException if there was an error fetching the recommended apps
    */
  def getRecommendedAppsByPackages(packages: Seq[String], excludePackages: Seq[String] = Seq.empty)(implicit context: ContextSupport): TaskService[Seq[NotCategorizedPackage]]
}
